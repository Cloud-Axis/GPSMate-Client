/*
 * Copyright 2012 - 2021 Anton Tananaev (anton@gpsmate.org)
 *
...
class MainFragment : PreferenceFragmentCompat(), OnSharedPreferenceChangeListener {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        alarmIntent = PendingIntent.getBroadcast(activity, 0, Intent(activity, com.gpsmate.client.AutostartReceiver::class.java), PendingIntent.FLAG_UPDATE_CURRENT)
